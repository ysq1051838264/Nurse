...
import com.ysq.nurse.ui.util.HackyViewPager;
import com.ysq.nurse.ui.util.ImageLoaderUtil;
import com.ysq.nurse.ui.util.MyScrollView;
import com.ysq.nurse.ui.util.SwipeBackLayout;
 ...
 * date: 2017/9/24 .
 */
public class ImageBrowseActivity extends BaseActivity implements NewsContract.View {
    ...
    public static void launch(Activity context, NewsDetail.ItemBean bodyBean) {
        ...
        if (bodyBean.getId().contains("http://api.3g.ifeng.com/")
...
//        StatusBarUtil.setColor(this, ContextCompat.getColor(this, android.R.color.black));
    ...
    @Override
    public void loadNewsData(NewsArticleBean newsArticleBean) {
        try {
